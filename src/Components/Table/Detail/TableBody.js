                ...
                switch (r[0]) {
                  case "priority":
                    ...
                    return (
                      <td
                        key={index}
                        className="px-4 py-4  w-8 text-sm leading-5 text-gray-500"
                      >
                        <StatusButton
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <span className="font-semibold text-betterfit-graphite ml-2 width-control-table">
                            {r[1]}
                          </span>
                        </div>
                      </td>
                  ...
                  default:
                    return (
                      <td
                        key={index}
                        className="px-4 py-4  text-base leading-5 text-betterfit-grey-blue"
                      >
