...
const TermsOfService = () => {
  return (
    <div className={styles.root}>
      ...
      <p className={styles.terms}>{text}</p>
    </div>
  );
};
...
These website terms and conditions of use for Betterfit.com, constitute a legal agreement and are
entered into by and between you and Cole Webber Productions Inc., ("Company," "we," "us,"
"our"). The following terms and conditions, together with any documents and/or additional
terms they expressly incorporate by reference (collectively, these "Terms and Conditions"),
govern your access to and use, including any content, functionality, and services offered on or
through Betterfit.com (the "Website").
...
https://betterfit.com/privacy-policy/, INCORPORATED HEREIN BY REFERENCE. IF
YOU DO NOT AGREE TO THESE TERMS AND CONDITIONS OR THE PRIVACY
POLICY, YOU MUST NOT ACCESS OR USE THE WEBSITE.
By using this Website, you represent and warrant that you are the legal age of majority under
...
acceptance of these.
The information and material on this Website, and the Website, may be changed, withdrawn, or
terminated at any time in our sole discretion without notice. We will not be liable if, for any
reason, all or any part of the Website is restricted to users or unavailable at any time or for any
period.
Your Use of the Website and Account Set-Up and Security
The security of your personal information is very important to us. We use physical, electronic,
and administrative measures designed to secure your personal information from accidental loss
...
access the Website through a user's internet connection are aware of these Terms and Conditions
and comply with them. The Website, including content or areas of the Website, may require user

registration. It is a condition of your use of the Website that all the information you provide on
...
Your provision of registration information and any submissions you make to the Website
through any functionality such as applications, e-mail, message boards, servers and application
programming interfaces (APIs) (collectively, "Interactive Functions") constitutes your consent
to all actions we take with respect to such information consistent with our Privacy Policy, found
at https://betterfit.com/privacy-policy/.
Any username, password, or any other piece of information chosen by you, or provided to you as
part of our security procedures, must be treated as confidential, and you must not disclose it to
any other person or entity. You must exercise caution when accessing your account from a public
or shared computer so that others are not able to view or record your password or other personal
...
portions of it using your username, password, or other security information. You agree to notify
us immediately of any unauthorized access to or use of your username or password or any other
...
Website, including, without limitation: (a) accessing content and data that is not intended for
you; (b) attempting to breach or breaching the security and/or authentication measures which are
not authorized; (c) restricting, disrupting or disabling service to users, hosts, servers, or
networks; (d) illicitly reproducing TCP/IP packet header; (e) disrupting network services and
otherwise disrupting Website owner's ability to monitor the Website; (f) using any robot, spider,
or other automatic device, process, or means to access the Website for any purpose, including
monitoring or copying any of the material on the Website; (g) introducing any viruses, trojan
horses, worms, logic bombs, or other material that is malicious or technologically harmful; (h)
attacking the Website via a denial-of-service attack, distributed denial-of-service attack,
...
BETTERFIT, the Company logo, and all related names, logos, product and service names,
...
this Website are the trademarks of their respective owners. Use of any such property, except as
...
action.
You shall not directly or indirectly reproduce, compile for an internal database, distribute,
modify, create derivative works of, publicly display, publicly perform, republish, download,
store, or transmit any of the material on our Website, in any form or medium whatsoever except:
...
proprietary notices thereon, which may only be used for non-commercial and lawful
personal use and not for further reproduction, publication, or distribution of any kind on
any medium whatsoever; and
(c) in the event social media platforms are linked to certain content on our Website,
you may take such actions as our Website and such third-party social media platforms
permit.
...
site. You must not access or use for any commercial purposes any part of the Website or any
...
reserved by the Company. Any use of the Website not expressly permitted by these Terms and
Conditions is a breach of these Terms and Conditions and may infringe or violate copyright,
...
As a condition of your access and use, you agree that you may use the Website only for lawful
purposes and in accordance with these Terms and Conditions.
The following content standards apply to any and all content, material, and information a user
submits, posts, publishes, displays, or transmits (collectively, "submit") to the website, to other
users or other persons (collectively, "User Submissions") and any and all Interactive Functions.
Any and all User Submissions must comply with all applicable federal, provincial, local, and
...
could give rise to any civil or criminal liability under applicable laws or regulations or
that otherwise may be in conflict with these Terms and Conditions and our Privacy Policy
found at https://betterfit.com/privacy-policy/.
(b) In any manner violate the terms of use of any third-party website that is linked to
the Website, including but not limited to, any third-party social media website.
...
inflammatory, or discriminatory based on race, sex, religion, nationality, disability,
sexual orientation, or age or other such legally prohibited ground or be otherwise
objectionable, such determination to be made in Company's sole discretion.
(d) Involve, provide, or contribute any false, inaccurate, or misleading information.
(e) Impersonate or attempt to impersonate the Company, a Company employee,
...
(f) Transmit, or procure the sending of, any advertisements or promotions without
our prior written consent, sales, or encourage any other commercial activities, including,
without limitation, any "spam", "junk mail", "chain letter", contests, sweepstakes and
other sales promotions, barter, or advertising or any other similar solicitation.
(g) Encourage any other conduct that restricts or inhibits anyone's use or enjoyment
of the Website, or which, as determined by us, may harm the Company or users of the
Website or expose them to liability.
(h) Cause annoyance, inconvenience, or needless anxiety or be likely to upset,
embarrass, or alarm any other person.

(i) Promote any illegal activity, or advocate, promote, or assist any unlawful act.
(j) Give the impression that they originate from or are endorsed by us or any other
...
assigns the right to a world-wide, royalty free, perpetual, irrevocable, non-exclusive licence to
use, reproduce, modify, perform, display, distribute, and otherwise disclose to third parties any
such material for any purpose and according to your account settings and/or incorporate such
material into any form, medium or technology throughout the world without compensation to
you. You further waive any moral rights or other rights of authorship as a condition of
submitting any User Submission.
By submitting the User Submissions, you declare and warrant that you own or have the
necessary rights to submit the User Submissions and have the right to grant the licence hereof to
...
regulations and the User Submissions and Site Content Standards set out in these Terms and
Conditions.
...
contractors, licensors, suppliers, or successors, are fully responsible for any User Submissions
you submit or contribute, and you are fully responsible and legally liable, including to any third
party, for such content and its accuracy. We are not responsible or legally liable to any third
party for the content or accuracy of any User Submissions submitted by you or any other user of
the Website.
Site Monitoring and Enforcement, Suspension, and Termination
Company has the right, without provision of notice to:
• Remove or refuse to post on the Website any User Submissions for any or no reason in
our sole discretion.
• At all times, take such actions with respect to any User Submission deemed necessary or
appropriate in our sole discretion, including, without limitation, for violating the Website
and User Submissions and Site Content Standards or Terms and Conditions.
• Take appropriate legal action, including, without limitation, referral to law enforcement
or regulatory authority, or notifying the harmed party of any illegal or unauthorized use

of the Website. Without limiting the foregoing, we have the right to fully cooperate with
...
YOU WAIVE AND HOLD HARMLESS THE COMPANY AND ITS SUBSIDIARIES,
AFFILIATES, AND THEIR RESPECTIVE DIRECTORS, OFFICERS, EMPLOYEES,
AGENTS, SERVICE PROVIDERS, CONTRACTORS, LICENSORS, LICENSEES,
SUPPLIERS, AND SUCCESSORS FROM ANY AND ALL CLAIMS RESULTING FROM
ANY ACTION TAKEN BY THE COMPANY AND ANY OF THE FOREGOING PARTIES
...
advice before taking, or refraining from, any action or inaction on the basis of the content on our
site.
...
This Website includes content provided by third parties, including from other users and thirdparty licensors. All statements and/or opinions expressed in any such third-party content, other
than the content provided by the Company, are solely the opinions and the responsibility of the
person or entity providing those materials. Such materials do not necessarily reflect the opinion
of the Company. Neither the Company nor its parent, subsidiaries, affiliates, and their respective
...
compliance with our Privacy Policy, found at https://betterfit.com/privacy-policy/, as we deem
necessary for use of the Website and provision of services.
...
the Website may not function adequately. For more information on this automated information
gathering practices, see https://betterfit.com/privacy-policy/.
...
contents of any such third-party sites and accept no responsibility for such sites or for any loss or
damage that may arise from your use of them. You are subject to any terms and conditions of
...
Use and User Submissions and Site Content Standards. You agree to cooperate with us in
causing any unauthorized framing or linking to immediately stop.
Online Purchases
All orders, purchases or transactions for the sale of goods made using this Website are subject to
the Terms and Conditions of Sale of Goods, found at https://betterfit.com/wpcontent/uploads/Sale_of_Goods_Terms_E9282035.pdf also incorporated into these Terms and
Conditions.
Geographic Restrictions
The owner of the Website is based in the Province of Alberta in Canada. We provide this
Website for use only by persons located in Canada. This Website is not intended for use in any
jurisdiction where its use is not permitted. If you access the Website from outside Canada, you
do so at your own risk and you are responsible for compliance with local laws of your
jurisdiction.

Disclaimer of Warranties
YOU UNDERSTAND AND AGREE THAT YOUR USE OF THE WEBSITE, ITS CONTENT,
AND ANY SERVICES OR ITEMS FOUND OR ATTAINED THROUGH THE WEBSITE IS
...
FOREGOING, NEITHER THE COMPANY NOR ITS PARENT, SUBSIDIARIES,
...
SUCCESSORS REPRESENT OR WARRANT THAT THE WEBSITE, ITS CONTENT, OR
ANY SERVICES OR ITEMS FOUND OR ATTAINED THROUGH THE WEBSITE WILL BE
ACCURATE, RELIABLE, ERROR-FREE, OR UNINTERRUPTED, THAT DEFECTS WILL
BE CORRECTED, THAT OUR WEBSITE OR THE SERVER THAT MAKES IT
...
INTERNET, AND DATA SECURITY. TO THE FULLEST EXTENT PROVIDED BY LAW,
WE WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE CAUSED BY DENIAL-OFSERVICE ATTACK, DISTRIBUTED DENIAL-OF-SERVICE ATTACK, OVERLOADING,
FLOODING, MAILBOMBING, OR CRASHING, VIRUSES, TROJAN HORSES, WORMS,
LOGIC BOMBS, OR OTHER TECHNOLOGICALLY HARMFUL MATERIAL THAT MAY
...
OR ITEMS FOUND OR ATTAINED THROUGH THE WEBSITE OR TO YOUR
...
MISREPRESENTATION, FUNDAMENTAL BREACH, DAMAGES OF ANY KIND,
...
CAUSED BY TORT (INCLUDING NEGLIGENCE), BREACH OF CONTRACT, BREACH
OF PRIVACY, OR OTHERWISE, EVEN IF THE PARTY WAS ALLEGEDLY ADVISED OR
HAD REASON TO KNOW, ARISING OUT OF OR IN CONNECTION WITH YOUR USE,
OR INABILITY TO USE, OR RELIANCE ON, THE WEBSITE, ANY LINKED WEBSITES
OR SUCH OTHER THIRD-PARTY WEBSITES, NOR ANY WEBSITE CONTENT,
MATERIALS, POSTING, OR INFORMATION THEREON EVEN IF THE PARTY WAS
...
fees (including reasonable lawyers’ fees) arising out of or relating to your breach of these Terms
and Conditions or your use of the Website, including, but not limited to, your User Submissions,
third-party sites, any use of the Website's content, services, and products other than as expressly
...
laws of the Province of Alberta or any other jurisdiction) and notwithstanding your domicile,
residence, or physical location.
Any action or proceeding arising out of or relating to this Website and under these Terms and
Conditions will be instituted in the courts of the Province of Alberta and/or the Federal Court of
...
partial exercise of any right, remedy, power, or privilege hereunder precludes any other or
...
Entire Agreement
The Terms and Conditions, our Privacy Policy and our Terms and Conditions for Sale of Goods
constitute the sole and entire agreement between you and Cole Webber Productions Inc.
regarding the Website and supersedes all prior and contemporaneous understandings,
agreements, representations and warranties, both written and oral, regarding such subject matter.
Reporting and Contact
This website is operated by Cole Webber Productions Inc., 6 Sunnyside Crescent, Red Deer,
Alberta, Canada, T4N 0E8.
Should you become aware of misuse of the website including libelous or defamatory conduct,
you must report it to the Company at info@betterfit.com.
All other feedback, comments, requests for technical support, and other communications relating
to the Website should be directed to info@betterfit.com.
October 6, 2021
`;
