    ...
    return (
        <div className="flex flex-col py-2 justify-start">
            ...
            <button
                ...
                className="mb-2 px-1 py-2 flex justify-between items-center rounded-l-lg bg-status-red translate-x-1 border border-status-dark-red border-opacity-0 hover:border-opacity-100"
                onClick={() => {
